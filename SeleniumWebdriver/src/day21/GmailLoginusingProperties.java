...
public class GmailLoginusingProperties {
	...
	{
		FileInputStream f=new FileInputStream("E:\\Sep30Batch\\SeleniumWebdriver\\GmailLogin.properties");
		...
		Thread.sleep(1000);
		driver.findElement(By.id(pr.getProperty("txt_password"))).sendKeys("passs@123");
