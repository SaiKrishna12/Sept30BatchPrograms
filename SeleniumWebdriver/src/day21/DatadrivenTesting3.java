...
public class DatadrivenTesting3 {
	...
	public void setUp()
	{
		...
		driver.get("https://care.ideacellular.com/wps/portal/account/express-paybill?gclid=CMH9zd7BjckCFU0pjgoddosEtA#Z7_JH56H4K0K8MP90AS8PIGS60CN3?iFrameAction=com.idea.selfcare.action.UrlRedirectAction");
		
	}
	@Test
	public void registrationTest() throws IOException
	{
		FileInputStream f=new FileInputStream("E:\\Sep30Batch\\SeleniumWebdriver\\src\\com\\qedge\\excelfiles\\Ajaxdata.xlsx");
		...
		while(row.hasNext())
		{
			...
			driver.findElement(By.id("ns_Z7_JH56H4K0KOIPA0ASI08BTI30O5_amountPaid")).click();
		...
		FileOutputStream f1=new FileOutputStream("E:\\Sep30Batch\\SeleniumWebdriver\\src\\com\\qedge\\resultexcelfiles\\Ajaxdata.xlsx");
		wb.write(f1);
		f1.close();
	}		
